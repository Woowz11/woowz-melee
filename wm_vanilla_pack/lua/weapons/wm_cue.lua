...
if WMLib then
	local Info = {
		...
		VModelPos = Vector(-3,3,3),
		VModelRot = Angle(0,-5,-10),
		VModelBones = {["main"] = {Vector(0,0,0),Angle(0,0,0),Vector(0,0,0),false}},
		VModelElements = {{"models/billiards/cue.mdl","ValveBiped.Bip01_R_Hand",Vector(16.5,-1.5,-45),Angle(-105,0,0),Vector(1,1,1)}},
		FOV = 50,
		WModel = "models/billiards/cue.mdl",
		Hold = "melee2",
